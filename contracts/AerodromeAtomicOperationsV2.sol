...
/**
 * @title AerodromeAtomicOperationsV2
 * @author N0IR
 * @notice Improved atomic operations with oracle integration for accurate pricing
 * @dev Uses 1inch Offchain Oracle for USD price discovery
 */
contract AerodromeAtomicOperationsV2 is AtomicBase, IERC721Receiver {
        ...
        returns (uint256 usdcOut, uint256 aeroRewards)
    {
        ...
        address pool = WETH_USDC_POOL; // For testing, in production this would be determined from position
